...
use App\Filament\Resources\PlatformResource\Widgets\TransactionsPerPlatformChart;
...
use App\Filament\Resources\TransactionResource\Widgets\StatsOverviewToday;
...
class AdminPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->widgets([
                //StatsOverview::class,
                StatsOverviewToday::class,
                TransactionsChart::class,
                TransactionsPerPlatformChart::class,
